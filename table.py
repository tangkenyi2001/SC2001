...
if __name__ == "__main__":
    ...
    table = PrettyTable()
    table.field_names = ["Array Size (n)", "S Value (s)", "Average HybridSort Time (s)", "Average HybridSort Comparisons"]
    ...
    for n in array_sizes:
        ...
        for s in s_values:
            ...
            # Run the experiment multiple times to get more reliable results
            ...
            avg_hybrid_comparisons = sum(hybrid_comparisons) / len(hybrid_comparisons)

            # Append data to the table
            table.add_row([n, s, avg_hybrid_time, avg_hybrid_comparisons])
